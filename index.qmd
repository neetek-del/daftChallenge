...
# Create the PGM (Probabilistic Graphical Model)
pgm = daft.PGM(dpi=150, aspect=1.6)

# Add nodes for Lemons and Scurvy Prevention
pgm.add_node("lemons", "Lemons / Citrus Intake", 0, 0, aspect=3, scale=1.2,
             plot_params={'facecolor':'#ffe066', 'edgecolor':'orange', 'linewidth':2})
pgm.add_node("scurvy", "Scurvy Prevention", 3, 0, aspect=3, scale=1.2,
             plot_params={'facecolor':'#b3ffb3', 'edgecolor':'green', 'linewidth':2})

# Add directional edge showing the causal link
pgm.add_edge("lemons", "scurvy")

# Render and display
pgm.render()
plt.title("DAG 1: 1747 Understanding — Lemons prevent Scurvy", fontsize=12)
plt.show()
...
pgm = daft.PGM(dpi=150, aspect=1.8)

# Add nodes for Acid, Bacteria Death, and Scurvy Prevention
pgm.add_node("acid", "Acid (from Lemons)", 0, 0, aspect=3, scale=1.1,
             plot_params={'facecolor':'#ffcccc', 'edgecolor':'darkred', 'linewidth':2})
pgm.add_node("bacteria", "Bacteria Death", 2, 0, aspect=3, scale=1.1,
             plot_params={'facecolor':'#ffebcc', 'edgecolor':'brown', 'linewidth':2})
pgm.add_node("scurvy", "Scurvy Prevention", 4, 0, aspect=3, scale=1.1,
             plot_params={'facecolor':'#b3ffb3', 'edgecolor':'green', 'linewidth':2})

# Add edges to represent the incorrect causal chain
pgm.add_edge("acid", "bacteria")
pgm.add_edge("bacteria", "scurvy")

# Render and display
pgm.render()
plt.title("DAG 2: Misguided Belief — Acid kills Bacteria → prevents Scurvy", fontsize=12)
plt.show()
...
# Add nodes for Vitamin C and Scurvy Prevention
pgm.add_node("vitamin_c", "Vitamin C Intake", 0, 0, aspect=3, scale=1.2,
             plot_params={'facecolor':'#ccffcc', 'edgecolor':'darkgreen', 'linewidth':2})
pgm.add_node("scurvy", "Scurvy Prevention", 3, 0, aspect=3, scale=1.2,
             plot_params={'facecolor':'#b3e6ff', 'edgecolor':'navy', 'linewidth':2})

# Add edge showing the correct causal link
pgm.add_edge("vitamin_c", "scurvy")

# Render and display
pgm.render()
plt.title("DAG 3: 1928 Understanding — Vitamin C prevents Scurvy", fontsize=12)
plt.show()
